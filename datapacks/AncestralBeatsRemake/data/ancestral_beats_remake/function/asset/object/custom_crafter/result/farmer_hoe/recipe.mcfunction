#> ancestral_beats_remake:asset/object/custom_crafter/result/farmer_hoe/recipe
#
# miner pickaxe recipe
#
# @within ancestral_beats_remake:asset/object/custom_crafter/result/farmer_hoe/check
