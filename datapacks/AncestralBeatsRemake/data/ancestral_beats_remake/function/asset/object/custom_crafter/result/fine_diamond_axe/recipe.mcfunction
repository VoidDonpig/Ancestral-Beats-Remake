#> ancestral_beats_remake:asset/object/custom_crafter/result/fine_diamond_axe/recipe
#
# miner axe recipe
#
# @within ancestral_beats_remake:asset/object/custom_crafter/result/fine_diamond_axe/check
