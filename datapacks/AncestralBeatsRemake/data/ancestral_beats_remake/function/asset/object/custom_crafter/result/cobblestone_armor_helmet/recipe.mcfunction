#> ancestral_beats_remake:asset/object/custom_crafter/result/cobblestone_armor_helmet/recipe
#
# miner pickaxe recipe
#
# @within ancestral_beats_remake:asset/object/custom_crafter/result/cobblestone_armor_helmet/check
