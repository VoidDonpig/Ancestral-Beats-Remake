#> ancestral_beats_remake:asset/object/custom_crafter/result/energetic_pickaxe/recipe
#
# miner pickaxe recipe
#
# @within ancestral_beats_remake:asset/object/custom_crafter/result/energetic_pickaxe/check
...
# check recipe
    ...
    if data block ~ ~-1 ~ Items[{Slot:2b,components:{"minecraft:custom_data":{donpig_abrm:{asset:{item:{custom_item_id:"crimson_alloy"}}}}},count:1}] \
