#> ancestral_beats_remake:asset/object/custom_crafter/result/unstable_eye_of_ender/recipe
#
# miner pickaxe recipe
#
# @within ancestral_beats_remake:asset/object/custom_crafter/result/unstable_eye_of_ender/check
