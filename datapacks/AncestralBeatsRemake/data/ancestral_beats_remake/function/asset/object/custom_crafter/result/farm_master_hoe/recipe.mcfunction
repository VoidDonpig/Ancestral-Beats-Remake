...
# check recipe
    ...
    if data block ~ ~-1 ~ Items[{Slot:1b,components:{"minecraft:custom_data":{donpig_abrm:{asset:{item:{custom_item_id:"farmer_hoe"}}}}},count:1}] \
    ...
    if data block ~ ~-1 ~ Items[{Slot:4b,components:{"minecraft:custom_data":{donpig_abrm:{asset:{item:{custom_item_id:"maximum_eye_of_ender"}}}}},count:1}] \
    if data block ~ ~-1 ~ Items[{Slot:5b,components:{"minecraft:custom_data":{donpig_abrm:{asset:{item:{custom_item_id:"crimson_alloy"}}}}},count:1}] \
    if data block ~ ~-1 ~ Items[{Slot:6b,id:"minecraft:hay_block",count:16}] \
    if data block ~ ~-1 ~ Items[{Slot:7b,components:{"minecraft:custom_data":{donpig_abrm:{asset:{item:{custom_item_id:"scythe_hoe"}}}}},count:1}] \
