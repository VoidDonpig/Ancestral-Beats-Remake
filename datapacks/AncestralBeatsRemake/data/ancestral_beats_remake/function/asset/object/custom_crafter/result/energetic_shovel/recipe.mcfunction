#> ancestral_beats_remake:asset/object/custom_crafter/result/energetic_shovel/recipe
#
# miner shovel recipe
#
# @within ancestral_beats_remake:asset/object/custom_crafter/result/energetic_shovel/check
