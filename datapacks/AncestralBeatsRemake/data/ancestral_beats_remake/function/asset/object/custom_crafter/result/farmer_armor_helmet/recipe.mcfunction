#> ancestral_beats_remake:asset/object/custom_crafter/result/farmer_armor_helmet/recipe
#
# miner pickaxe recipe
#
# @within ancestral_beats_remake:asset/object/custom_crafter/result/farmer_armor_helmet/check
