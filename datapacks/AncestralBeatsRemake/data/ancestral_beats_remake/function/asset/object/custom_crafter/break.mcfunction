#> ancestral_beats_remake:asset/object/custom_crafter/break
#
# when broken
#
...
# kill old dropper
    kill @n[type=item,predicate=ancestral_beats_remake:asset/object/custom_crafter/is_broken_dropper]
