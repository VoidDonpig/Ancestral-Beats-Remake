#> ancestral_beats_remake:asset/mob/zombie_villager/init/data
#
# define the data
#
# @within ancestral_beats_remake:asset/mob/zombie_villager/init/
...
# set data
    ...
    execute unless items entity @s armor.head * run data modify storage ancestral_beats_remake:mob data.equipment.head set value {"id":"leather_helmet","components":{dyed_color:4334857}}
