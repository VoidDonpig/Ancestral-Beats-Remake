#> ancestral_beats_remake:asset/mob/void_seraphim/init/data
#
# define the data
#
...
# set data
    data modify storage ancestral_beats_remake:mob data.CustomName set value {"text":"Void Seraphim","bold":true,"color":"dark_purple"}
    ...
    data modify storage ancestral_beats_remake:mob data.DeathLootTable set value "ancestral_beats_remake:asset/mob/void_seraphim"
...
# define attribute
    data modify storage ancestral_beats_remake:mob data.health set value 200.0
    data modify storage ancestral_beats_remake:mob data.damage set value 20.0
