#> ancestral_beats_remake:asset/mob/special_void_seraphim/init/data
#
# define the data
#
# @within ancestral_beats_remake:asset/mob/special_void_seraphim/init/

# set data
    data modify storage ancestral_beats_remake:mob data.CustomName set value {"text":"Special Void Seraphim","bold":true,"color":"dark_purple"}
    data modify storage ancestral_beats_remake:mob data.CustomNameVisible set value 1b

    #data modify storage ancestral_beats_remake:mob data.active_effects set value [{id:"glowing",duration:-1,"amplifier":0,"show_particles":true}]

    #data modify storage ancestral_beats_remake:mob data.equipment.head set value {"id":"leather_helmet","components":{dyed_color:1420677}}
    ...
    data modify storage ancestral_beats_remake:mob data.equipment.feet set value {"id":"dirt",components:{enchantments:{frost_walker:2}}}
    ...
    data modify storage ancestral_beats_remake:mob data.DeathLootTable set value "ancestral_beats_remake:asset/mob/special_void_seraphim"
    ...
    data modify storage ancestral_beats_remake:mob data.drop_chances set value {"feet":0.0f}

    #data modify storage ancestral_beats_remake:mob data.CanPickUpLoot set value 1b

# define attribute
    data modify storage ancestral_beats_remake:mob data.health set value 10.0
    data modify storage ancestral_beats_remake:mob data.damage set value 10.0
    #data modify storage ancestral_beats_remake:mob data.armor set value 10.0
    #data modify storage ancestral_beats_remake:mob data.armor_toughness set value 4.0
    #data modify storage ancestral_beats_remake:mob data.attack_knockback set value 0.6
    #data modify storage ancestral_beats_remake:mob data.knockback_resistance set value 0.4
    data modify storage ancestral_beats_remake:mob data.movement_speed set value 0.23
