#> ancestral_beats_remake:asset/mob/drowned/init/data
#
# define the data
#
# @within ancestral_beats_remake:asset/mob/drowned/init/
...
# set data
    ...
    execute unless items entity @s armor.head * run data modify storage ancestral_beats_remake:mob data.equipment.head set value {"id":"leather_helmet","components":{dyed_color:747670}}
    ...
    execute unless items entity @s weapon.mainhand * run data modify storage ancestral_beats_remake:mob data.equipment.mainhand set value {"id":"wooden_sword"}
...
# define attribute
    ...
    execute unless predicate ancestral_beats_remake:asset/mob/is_baby run data modify storage ancestral_beats_remake:mob data.movement_speed set value 0.32
