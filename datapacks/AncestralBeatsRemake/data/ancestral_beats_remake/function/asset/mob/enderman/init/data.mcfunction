#> ancestral_beats_remake:asset/mob/enderman/init/data
#
# define the data
#
# @within ancestral_beats_remake:asset/mob/enderman/init/

# set data
    #data modify storage ancestral_beats_remake:mob data.CustomName set value {"text":"name"}
    #data modify storage ancestral_beats_remake:mob data.CustomNameVisible set value 1b

    #data modify storage ancestral_beats_remake:mob data.active_effects set value [{id:"",duration:-1,"amplifier":0,"show_particles":false}]
...
# define attribute
    #data modify storage ancestral_beats_remake:mob data.health set value 1024.0
    #data modify storage ancestral_beats_remake:mob data.damage set value 1024.0
    data modify storage ancestral_beats_remake:mob data.armor set value 2.0
