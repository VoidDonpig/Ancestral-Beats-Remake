#> ancestral_beats_remake:asset/mob/lapis_zombie/init/data
#
# define the data
#
# @within ancestral_beats_remake:asset/mob/lapis_zombie/init/

# set data
    data modify storage ancestral_beats_remake:mob data.CustomName set value {"text":"Lapis Zombie","color":dark_blue,"bold":true}
    data modify storage ancestral_beats_remake:mob data.CustomNameVisible set value 1b

    #data modify storage ancestral_beats_remake:mob data.active_effects set value [{id:"glowing",duration:-1,"amplifier":0,"show_particles":false}]
    ...
    data modify storage ancestral_beats_remake:mob data.DeathLootTable set value "ancestral_beats_remake:asset/mob/lapis_zombie"
...
# define attribute
    data modify storage ancestral_beats_remake:mob data.health set value 46.0
    #data modify storage ancestral_beats_remake:mob data.damage set value 1024.0
    data modify storage ancestral_beats_remake:mob data.armor set value 8.0
    ...
    execute unless predicate ancestral_beats_remake:asset/mob/is_baby run data modify storage ancestral_beats_remake:mob data.movement_speed set value 0.48
