...
# show actionbar
    title @s actionbar ["",{"text":"❤","color":red}," ",{"score":{"name":"@s","objective":"donpig_abrm.player.status.hp"},"color":white},{"text":"/","color":gray},{nbt:"_[-4][-4][-4][-4][-4][-4][-4][-4].max_health",storage:"ancestral_beats_remake:lib","interpret":false,"color":"gray"},"    ",{"text":"✎","color":aqua}," ",{"score":{name:"@s",objective:"donpig_abrm.player.status.mp"},color:"white"},{"text":"/",color:"gray"},{"score":{name:"@s",objective:"donpig_abrm.player.status.mp_max"},color:gray}]
