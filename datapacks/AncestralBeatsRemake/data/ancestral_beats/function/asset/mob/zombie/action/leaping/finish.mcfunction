#> ancestral_beats:asset/mob/zombie/action/leaping/finish
#
# finish leaping
#
...
# remove tag
    tag @s remove ancestral_beats.asset.mob.leaping.doing
    tag @s remove ancestral_beats.asset.mob.leaping.able_to_end

# face opponent
    execute facing entity @n[tag=ancestral_beats.asset.mob.target] eyes run tp @s ~ ~ ~ ~ ~

# remove attribute
    attribute @s minecraft:attack_knockback modifier remove ancestral_beats:asset.mob.leaping.attack_knockback_increase
