#> ancestral_beats:asset/mob/special_void_seraphim/init/data
#
# define the data
#
# @within ancestral_beats:asset/mob/special_void_seraphim/init/

# set data
    data modify storage ancestral_beats:mob data.CustomName set value {"text":"Special Void Seraphim","bold":true,"color":"dark_purple"}
    ...
    data modify storage ancestral_beats:mob data.DeathLootTable set value "ancestral_beats:asset/mob/special_void_seraphim"
...
# define attribute
    data modify storage ancestral_beats:mob data.health set value 10.0
    data modify storage ancestral_beats:mob data.damage set value 10.0
    ...
    data modify storage ancestral_beats:mob data.movement_speed set value 0.23
