#> ancestral_beats:asset/object/custom_crafter/result/fermented_flesh/recipe
#
# miner pickaxe recipe
#
# @within ancestral_beats:asset/object/custom_crafter/result/fermented_flesh/check
