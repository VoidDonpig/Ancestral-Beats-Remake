#> ancestral_beats:asset/object/custom_crafter/result/rotten_armor_helmet/recipe
#
# miner pickaxe recipe
#
# @within ancestral_beats:asset/object/custom_crafter/result/rotten_armor_helmet/check
