#> ancestral_beats:asset/object/custom_crafter/result/fine_diamond_sword/recipe
#
# miner pickaxe recipe
#
# @within ancestral_beats:asset/object/custom_crafter/result/fine_diamond_sword/check
