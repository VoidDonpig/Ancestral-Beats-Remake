#> ancestral_beats:asset/object/custom_crafter/result/rod_of_healing/recipe
#
# miner pickaxe recipe
#
# @within ancestral_beats:asset/object/custom_crafter/result/rod_of_healing/check
