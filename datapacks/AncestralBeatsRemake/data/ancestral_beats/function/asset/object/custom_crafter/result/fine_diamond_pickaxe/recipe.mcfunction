#> ancestral_beats:asset/object/custom_crafter/result/fine_diamond_pickaxe/recipe
#
# miner pickaxe recipe
#
# @within ancestral_beats:asset/object/custom_crafter/result/fine_diamond_pickaxe/check
