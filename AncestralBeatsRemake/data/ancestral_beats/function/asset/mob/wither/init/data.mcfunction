#> ancestral_beats:asset/mob/wither/init/data
#
# define the data
#
# @within ancestral_beats:asset/mob/wither/init/

# set data
    data modify storage ancestral_beats:mob data.CustomName set value {"text":"Wither","color":gray,"bold":true}
    data modify storage ancestral_beats:mob data.CustomNameVisible set value 1b

    data modify storage ancestral_beats:mob data.active_effects set value [{id:"resistance",duration:-1,"amplifier":3,"show_particles":false}]
    ...
    #data modify storage ancestral_beats:mob data.DeathLootTable set value "ancestral_beats:asset/mob/wither"
...
# define attribute
    data modify storage ancestral_beats:mob data.health set value 300.0
    ...
    #data modify storage ancestral_beats:mob data.movement_speed set value 0.48
