#> ancestral_beats:asset/object/custom_crafter/result/fine_diamond_shovel/recipe
#
# miner shovel recipe
#
# @within ancestral_beats:asset/object/custom_crafter/result/fine_diamond_shovel/check
