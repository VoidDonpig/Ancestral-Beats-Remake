#> ancestral_beats:asset/object/custom_crafter/result/purgatory_series_recipe_book/recipe
#
# miner pickaxe recipe
#
# @within ancestral_beats:asset/object/custom_crafter/result/purgatory_series_recipe_book/check
