#> ancestral_beats:asset/object/custom_crafter/result/rotten_armor_leggings/recipe
#
# miner pickaxe recipe
#
# @within ancestral_beats:asset/object/custom_crafter/result/rotten_armor_leggings/check
