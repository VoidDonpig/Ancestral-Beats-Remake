...
# set data
    ...
    execute unless predicate ancestral_beats:asset/mob/is_having_helmet run data modify storage ancestral_beats:mob data.equipment.head set value {"id":"leather_helmet"}
