#> ancestral_beats:asset/mob/the_ancestral_dragon/init/data
#
# define the data
#
...
# set data
    data modify storage ancestral_beats:mob data.CustomName set value ["",{"text":"✧༺","color":"gold"},{"text":"❖","color":"dark_red"},{"text":"༻✧ ","color":"gold"},{"text":"𝕋𝕙𝕖 𝔸𝕟𝕔𝕖𝕤𝕥𝕣𝕒𝕝 𝔻𝕣𝕒𝕘𝕠𝕟","color":"red"},{"text":" ✧༺","color":"gold"},{"text":"❖","color":"yellow"},{"text":"༻✧","color":"gold"}]
    data modify storage ancestral_beats:mob data.CustomNameVisible set value 1b

    data modify storage ancestral_beats:mob data.active_effects set value [{id:"minecraft:resistance",duration:-1,"amplifier":3,"show_particles":false}]

    #data modify storage ancestral_beats:mob data.equipment.head set value {"id":"leather_helmet","components":{dyed_color:747670}}
    ...
    #data modify storage ancestral_beats:mob data.equipment.mainhand set value {"id":"wooden_sword"}
...
# define attribute
    data modify storage ancestral_beats:mob data.health set value 4000.0
    ...
    data modify storage ancestral_beats:mob data.scale set value 1.2
