#> ancestral_beats:asset/object/custom_crafter/result/cobblestone_armor_chestplate/recipe
#
# miner pickaxe recipe
#
# @within ancestral_beats:asset/object/custom_crafter/result/cobblestone_armor_chestplate/check
