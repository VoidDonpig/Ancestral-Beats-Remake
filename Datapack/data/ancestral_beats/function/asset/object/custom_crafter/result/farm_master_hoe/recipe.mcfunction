#> ancestral_beats:asset/object/custom_crafter/result/farm_master_hoe/recipe
#
# miner pickaxe recipe
#
# @within ancestral_beats:asset/object/custom_crafter/result/farm_master_hoe/check
